...
//	return HAL_I2C_Mem_Write(imu->hi2c, LSM9DS1_AG_ADDR_WRITE, reg, I2C_MEMADD_SIZE_8BIT, &value, 1, 100);
//}
//
//HAL_StatusTypeDef mag_write(IMU_t *imu, uint8_t reg, uint8_t value) {
//	return HAL_I2C_Mem_Write(imu->hi2c, LSM9DS1_M_ADDR_WRITE, reg, I2C_MEMADD_SIZE_8BIT, &value, 1, 100);
//}
//
//HAL_StatusTypeDef acc_gyro_read(IMU_t *imu, uint8_t reg, uint8_t *buf, uint16_t len) {
//	return HAL_I2C_Mem_Read(imu->hi2c, LSM9DS1_AG_ADDR_READ, reg, I2C_MEMADD_SIZE_8BIT, buf, len, 100);
//}
//
//HAL_StatusTypeDef mag_read(IMU_t *imu, uint8_t reg, uint8_t *buf, uint16_t len) {
//	return HAL_I2C_Mem_Read(imu->hi2c, LSM9DS1_M_ADDR_READ, reg, I2C_MEMADD_SIZE_8BIT, buf, len, 100);
//}
